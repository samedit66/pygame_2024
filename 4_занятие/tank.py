...
class Tank(pygame.sprite.Sprite):
    def __init__(self, position: tuple[int, int], file_image: str):
        ...
        self.weapon  = pygame.image.load("tanks_images/blue/turret1.png").convert_alpha()
        ...
        self.weapon_rect = self.image.get_rect(topleft=position)
    ...
    def render(self, screen):
        ...
        screen.blit(self.weapon, self.weapon_rect)
...
class Game:
    ...
    def __init__(self):
        ...
        self.running = True
        self.tank = Tank(position=(0, 0), file_image="tanks_images/blue/body.png")
